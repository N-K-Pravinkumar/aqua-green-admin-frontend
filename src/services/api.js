...
export const seedCleanupAPI = {
  ...
  fixCustomerSince: () => api.post('/admin/seed-cleanup/customer-since/execute'),
};
...
export const saleAPI = {
  ...
  getRevenueChart: (granularity, count) => api.get('/sales/revenue-chart', { params: { granularity, count } }),
...
export const serviceRequestAPI = {
  ...
  getRevenueChart: (granularity, count) => api.get('/service-requests/revenue-chart', { params: { granularity, count } }),
